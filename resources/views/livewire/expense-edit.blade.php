        ...
        <div class="col-6 offset-3" >
            <div class="card mb-4" style="background-color:#bb95dc !important; color:#ffffff !important" >
                <div class="card-header d-flex align-items-center justify-content-center">
                    <h5 class="mb-0 text-white fs-3">Edit Expense</h5>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="">
                                <input type="text" class="form-control" id="basic-default-name" name='name'
                                    wire:model='name' placeholder="John Doe" value="{{$expense->name}}"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="">
                                <input type="number" class="form-control" id="basic-default-name" name='price'
                                    wire:model='amount' placeholder="1*****MMK" value="{{$expense->amount}}" />
                                <small class="text-danger">
                                    @error('amount')
                                        {{ $message }}
                                    @enderror
