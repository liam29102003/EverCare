...
<div class="container">
        <h2 class="text-center mt-5">{{__('form.Meet_Our_Doctors')}}</h2 class="text-center">
        <div style="height: 2px;width: 20%;" class="bg-dark m-auto"></div>
        <div class="text-center my-3 text-dark">{{__('form.Discover_Compassionate_Care_with_Our_Dedicated_Team_of_Exceptional_Doctors')}}</div>
...
@foreach($doctors as $d)
        <div class="col-8 col-md-3 m-3 position-relative ">
            ...
            @endforeach
            @else
            <h2>{{__('form.There_is_no_doctor_to_show.')}}</h2>
@endif
        </div>
