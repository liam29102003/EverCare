<div x-data='{open:true}' x-init="setTimeout(() => { open = false; }, 5000)">
    <div   x-show="open" x-bind:class='{"d-block":open}' class="bs-toast toast toast-placement-ex m-2  bg-danger" style="postion:absolute; top:0; right:0"  role="alert" aria-live="assertive"
