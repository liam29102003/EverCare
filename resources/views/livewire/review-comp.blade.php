    ...
    <div >
        <div class="container top" id="container" style=''>
            <div class="container-left">
                <h1>{{__("form.What_Our_Patients_Say")}}</h1>
                <p style='line-height:30px;font-size:18px;'>
                    {{__("form.review_about")}}
                </p>
                <p>
{{__("form.feed_gift")}}
                </p>
                @if(session('name') == "")
                <button class="main-button"><a href="{{route('login_page')}}"><i class="fa-regular fa-pen-to-square"></i> {{__("Write_Review")}}</a></button>
            @else
                <button class="main-button"><a href="#form-body"><i class="fa-regular fa-pen-to-square"></i> {{__("Write_Review")}}</a></button>
            @endif
            </div>
        ...
        <div class='form'>
            <div class="user-details d-flex align-items-center justify-content-center">
                <div class="input-box mt-3">
                    <span class="details"><i class="fa-regular fa-calendar-days"></i> {{__("form.Name")}} : </span>
...
<span class="text-danger">{{$message}}</span>
                ...
                <div class="input-box mt-3">
                    <span class="details"><i class="fa-solid fa-user"></i> {{__("form.Email")}} :</span>
...
<span class="text-danger">{{$message}}</span>
                ...
                <div class="input-box mt-3">
                    <span class="details"><i class="fa-regular fa-comments"></i> {{__("form.comment")}} :</span>
