...
<body>
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
	...
	@endif
	<a href="{{route('home')}}" class='btn m-3 px-5 pfbtn' wire:navigate>Back</a>
    <div class="container">
		<div class="main-body">
			<div class="row">
				<div class="col-lg-4">
						...
						<div class="card-body">
							<div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" wire:model='name' name='name' value="{{$name}}">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" wire:model='phone' value="{{$phone}}">
								</div>
							</div>
                            <div class="row mb-3">
								<div class="col-sm-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" wire:model='gender' value="{{$gender}}">
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="date" class="form-control" wire:model='dob' value="{{$dob}}">
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" wire:model='address' value="{{$address}}">
								</div>
							</div>
							<div class="row">
