...
<nav>
        ...
        <ul id="menuList" class='pt-3'>
            <li><a href="{{route('appointment.form')}}" wire:navigate class=" navBtn btn">{{ __('Make Appointment')}}</a></li>
            <li><a href="{{route('home')}}" wire:navigate class="navItem px-3 rounded me-3 py-2 ">{{__('Home')}}</a></li>
            <li><a href="{{route('doctor#list')}}" wire:navigate class="navItem px-3 rounded me-3 py-2 ">{{__('Doctors')}}</a></li>
            <li><a href="{{route('contactPage')}}" wire:navigate class="navItem px-3 rounded me-3 py-2 ">{{__('Contact')}}</a></li>
            <li><a href="{{route('patient.review')}}" wire:navigate class="navItem px-3 rounded me-3 py-2 ">{{__('Review')}}</a></li>
        <li>
